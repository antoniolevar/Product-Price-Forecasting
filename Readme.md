...
This Jupyter Notebook, `Sales Department.ipynb`, contains data analysis and visualization for the Sales Department. The analysis is based on the data provided in the `store.csv` and `train.csv` files.
...
2. Open the `Sales Department.ipynb` file in Jupyter Notebook.
